...
class PropertyProvider with ChangeNotifier {
  ...
  // Additional Fields
  String _roadAccess = "No";
  String _roadType = "Kankara Road";
  double _roadWidth = 15;
  String _landFacing = "East";
  String _lengthFacing = "";
  String _zone = "Residential Use Zone (R1)";
  String _nala = "No";
  ...
  // NEW: store which unit the user is entering
  String _areaRaw = 'sqyd';
  String get areaRaw => _areaRaw;
  void setAreaRaw(String unit) {
    _areaRaw = unit;
    notifyListeners();
  }
  ...
  String get lengthFacing => _lengthFacing;
  void setLengthFacing(String value) {
    _lengthFacing = value;
    notifyListeners();
  }
  ...
  String get nala => _nala;
  void setNala(String value) {
    _nala = value;
    notifyListeners();
  }
