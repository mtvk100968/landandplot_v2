...
import '../../../../services/geocodeing_services.dart';
...
//   //   final provider = _propertyProvider; // or Provider.of<PropertyProvider>(context, listen:false);
//   //   if (!mounted) return;
...
//   //   }
//   //   if (_taluqMandalController.text != provider.mandal) {
//   //     _taluqMandalController.text = provider.taluqMandal;
//   //   }
//   //   setState(() {});
//   // }
//
//   void _updateControllers(p) {
//     if (!mounted) return;
//     final p = _propertyProvider;
//     _pincodeController.text      = p.pincode;
//     _villageController.text      = p.village ?? '';
//     _taluqMandalController.text  = p.taluqMandal;
...
//   //     _updateControllers(_propertyProvider);
//   //   } catch (e) {
...
// }
  ...
  void initState() {
    ...
    _colonyNameController = TextEditingController(text: _propertyProvider.village);
    _addressController = TextEditingController(text: _propertyProvider.address ?? '');
    _districtController = TextEditingController(text: _propertyProvider.district ?? '');
    _cityController = TextEditingController(text: _propertyProvider.city);
          ...
          child: Column(
            ...
            children: [
              ...
              TextFormField(
                ...
                validator: Validators.requiredValidator,
                onChanged: (value) {
                  _propertyProvider.setPropertyName(value);
                },
              ),
              const SizedBox(height: 20),
