...
final areaStart = widget.initialMinArea != 0
? widget.initialMinArea
    : _config!.areaMin;
final areaEnd = widget.initialMaxArea != 0
...
print('   • TotalPriceRange = ${_totalPriceRange.start} – ${_totalPriceRange.end}');
print('   • UnitPriceRange  = ${_unitPriceRange.start} – ${_unitPriceRange.end}');
...
? _unitPriceRange
    : RangeValues(
_unitPriceRange.start.clamp(config.unitPriceMin, config.unitPriceMax),
...
? _totalPriceRange
    : RangeValues(
_totalPriceRange.start.clamp(config.totalPriceMin, config.totalPriceMax),
_totalPriceRange.end.clamp(config.totalPriceMin, config.totalPriceMax),
);
...
Text(_indianFormat
    .format(clampedUnitPrice.end.round())),
],
),
),
// RangeSlider(
...
children: [
Text(_indianFormat
    .format(clampedArea.start.round())),
Text(
