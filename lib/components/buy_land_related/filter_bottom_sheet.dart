          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                // 1️⃣a Development Subtype (only if Development is chosen)
                if (_type == fc.PropertyType.development) ...[
                  const SizedBox(height: 8),
                  const Text('Development subtype'),
                  Wrap(
                    spacing: 8,
                    children: [
                      ChoiceChip(
                        label: const Text('Development Plot'),
                        selected: _devSubtype == 'development_plot',
                        onSelected: (_) => setState(
                                () => _devSubtype = 'development_plot'),
                      ),
                      ChoiceChip(
                        label: const Text('Development Land'),
                        selected: _devSubtype == 'development_land',
                        onSelected: (_) => setState(
                                () => _devSubtype = 'development_land'),
                      ),
                    ],
                  ),
                ],
