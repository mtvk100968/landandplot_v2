...
//   final List<pt.PropertyType> _selectedTypes = [];
//
...
//
//   void _apply() {
//     // pick the first selected type, if any
//     final primaryType = _selectedTypes.isNotEmpty ? _selectedTypes.first : null;
//     final config = (primaryType != null)
//         ? fc.kFilterMap[primaryType]
//         : null;
//
//     Navigator.of(context).pop(<String, dynamic>{
//       'place':  _place,
//       'types':  _selectedTypes.map((t) => t.firestoreKey).toList(),
//       'unitPrice': _unitPriceRange,
//       'totalPrice': _totalPriceRange,
//       'area':      _areaRange,
//       'beds':      _beds,
//       'baths':     _baths,
...
//     final config = _selectedTypes.isEmpty
//         ? null
//         : fc.kFilterMap[
//     // if multiple selected, arbitrarily pick the first just for labels:
...
//                 if (_selectedTypes.isNotEmpty && config != null) ...[
//                   const SizedBox(height: 8),
//
...
//                     child: Opacity(
//                       opacity: _activeSlider == _ActiveSlider.unit ? .5 : 1,
//                       child: RangeSlider(
//                         min: config.totalPriceMin,
//                         max: config.totalPriceMax,
//                         values: _totalPriceRange,
//                         labels: RangeLabels(
//                           _indianFormat.format(_totalPriceRange.start.round()),
//                           _indianFormat.format(_totalPriceRange.end.round()),
//                         ),
...
// //   ),
// //   // If the unit‐price slider is active, disable total‐price
// //   onChanged: (r) => setState(() {
// //     _totalPriceRange = r;
// //     _useTotalPrice  = true;
// //     // _useUnitPrice   = false;
...
// //   activeColor: _useUnitPrice ? Colors.grey[300] : Theme.of(context).colorScheme.primary,
// // ),
//
//                   IgnorePointer(
...
// //     _indianFormat.format(clampedUnitPrice.end.round()),
// //   ),
// //   // If the total‐price slider is active, disable unit‐price
// //   onChanged: _useTotalPrice
// //       ? null
// //       : (r) => setState(() {
// //     _unitPriceRange = r;
// //     _useUnitPrice   = true;
...
// //
// //   // Grey out when disabled
// //   activeColor: _useTotalPrice ? Colors.grey[300] : Theme.of(context).colorScheme.primary,
// // ),
//
//                   IgnorePointer(
